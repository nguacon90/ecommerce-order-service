...
@Component
public class RefreshCartRequestValidator extends AbstractCartValidator implements Validator<RefreshCartRequest> {
    ...
    public void validate(RefreshCartRequest refreshCartRequest) throws ServiceException {
        if(refreshCartRequest.getOldCompanyId() == null) {
            ErrorCodes err = ErrorCodes.EMPTY_OLD_COMPANY;

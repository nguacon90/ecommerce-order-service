...
public class BillRequest implements Serializable {
    ...
    private Long originReturnBillId;
    ...
    public Set<BillDetailRequest> getBillDetails() {
        return billDetails;
    }

    public void setBillDetails(Set<BillDetailRequest> billDetails) {
    ...
    public Long getOriginReturnBillId() {
        return originReturnBillId;
    }

    public void setOriginReturnBillId(Long originReturnBillId) {
        this.originReturnBillId = originReturnBillId;
    }
}
